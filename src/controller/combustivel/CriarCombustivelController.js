...
class CriarCombustivelController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { km_inicial, km_final, carro_id, user_id, data, litros } = req.body;
            const criarCombustivelService = new CriarCombustivelService_1.CriarCombustivelService();
            const combustivel = yield criarCombustivelService.execute({ km_inicial, km_final, carro_id, user_id, data, litros });
